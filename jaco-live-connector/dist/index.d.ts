/**
 * Wrapper class for Jaco Live's internal Webcast Push Service
 */
export class WebcastPushConnection extends EventEmitter {
    /**
     * Create a new WebcastPushConnection instance
     * @param {string} uniqueId Jaco Live username (from URL)
     * @param {object} [options] Connection options
     * @param {boolean} [options.processInitialData=true] Process the initial data which includes messages of the last minutes
     ...
     * @param {boolean} [options.enableWebsocketUpgrade=true] Use WebSocket instead of request polling if Jaco Live offers it
     * @param {boolean} [options.enableRequestPolling=true] Use request polling if no WebSocket upgrade is offered. If `false` an exception will be thrown if Jaco Live does not offer a WebSocket upgrade.
...
export declare const signatureProvider: typeof import("./lib/jacoSignatureProvider");
export declare const webcastProtobuf: typeof import("./lib/jacoWebcastProtobuf.js");
